...
public class FBLogin /*: MonoBehaviour*/
{
    ...
    public delegate void FBUserInfoCallback(FBUserInfo fbUserInfo);
    public void FetchFBUserInfo(FBUserInfoCallback callback)
    {
    ...
    public delegate void FBProfilePictureCallback(Texture2D profilePicture);
    public void FetchFBProfilePicture(FBProfilePictureCallback callback)
    {
        FB.API("/" + m_fbAccessToken.UserId + "/picture?width=128&height=128", Facebook.Unity.HttpMethod.GET, (result) =>
        {
            ...
            callback(result.Texture);// Sprite.Create(, new Rect(0, 0, 128, 128), new Vector2(0, 0)));
        });
    }
